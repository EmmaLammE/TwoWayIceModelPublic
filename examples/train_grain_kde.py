...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_testdata_path', type=str, default='/oak/stanford/groups/jsuckale/liuwj/elle_grainsize_results/jcp/data/test/', help='Path to saved test data')
    parser.add_argument('--save_traindata_path', type=str, default='/oak/stanford/groups/jsuckale/liuwj/elle_grainsize_results/jcp/data/train_valid/', help='Path to saved train data')
