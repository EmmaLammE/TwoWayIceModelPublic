#!/bin/bash
#SBATCH --job-name=teuler3
#SBATCH --time=00:40:00
#SBATCH -p serc
#SBATCH --mem=20G
#SBATCH --gpus 1
#SBATCH -o ./../sbatch_outputs/out_jcp_test_euler3.out
#SBATCH -e ./../sbatch_outputs/err_jcp_test_euler3.err
...
python3 test_euler.py  --which_euler euler3 --epoch 500
